...
const linkFullstack = document.getElementById('link-fullstack');
const linkAI = document.getElementById('link-aiagent');
const linkPython = document.getElementById('link-pythonsoftware');

linkFullstack.addEventListener('click', () => {
    window.open('https://github.com/Arnavvid/FlexNotes', '_blank');
});

linkAI.addEventListener('click', () => {
    window.open('https://github.com/Arnavvid/Ai-Agent', '_blank');
});

linkPython.addEventListener('click', () => {
    window.open('https://github.com/Arnavvid/tournament-app', '_blank');
});
